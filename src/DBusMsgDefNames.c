...
const char* g_methodDABEventNames[TotalMethodDABEvent] = {
	METHOD_DAB_TURN_ON,
	METHOD_DAB_SELECT_PRESET,
};

const char* g_signalDABEventNames[TotalSignalDABEvent] = {
	SIGNAL_DAB_MODE,
	SIGNAL_DAB_FREQUENCY_CHANGED
};

const char* g_methodDRMEventNames[TotalMethodDRMEvent] = {
	METHOD_DRM_TURN_ON,
	METHOD_DRM_SELECT_PRESET
};

const char* g_signalDRMEventNames[TotalSignalDRMEvent] = {
	SIGNAL_DRM_MODE,
	SIGNAL_DRM_PRESET_CHANGED,
	SIGNAL_DRM_SERVICE_CHANGED
};

const char *g_radioTypeNames[TotalRadioTypes] = {
	"FM",
	"AM",
	"DAB",
	"DRM",
...
const char* g_methodMicomManagerEventNames[TotalMethodMicomManagerEvent] = {
